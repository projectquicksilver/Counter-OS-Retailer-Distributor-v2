        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              background: 'rgba(255,208,96,0.12)', borderRadius: '50%',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              border: '2px solid rgba(255,208,96,0.5)'
            }}>
              <span className="material-symbols-outlined" style={{ fontSize: '2.5rem', color: '#ffd060' }}>shopping_bag</span>
            </div>
            ...
            <p style={{ fontSize: '.9rem', color: 'var(--t2)', lineHeight: 1.6, marginBottom: '1.5rem' }}>
              ...
              <strong style={{ color: '#ffd060' }}>{orderPopup.items} items</strong> worth{' '}
              <strong style={{ color: '#ffd060' }}>₹{orderPopup.total?.toLocaleString('en-IN')}</strong>.
            </p>
            ...
            <div style={{ display: 'flex', gap: '.75rem' }}>
              ...
              <button
                ...
                style={{
                  flex: 2, background: '#ffd060', border: 'none', color: '#000',
