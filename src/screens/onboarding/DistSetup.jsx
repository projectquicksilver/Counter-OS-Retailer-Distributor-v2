...
const CAT_CONFIG = {
  agri:        {label:'Agri Distributor',      emoji:'🌾'},
  food:        {label:'Food & FMCG',           emoji:'📦'},
  pharma:      {label:'Pharma Wholesale',      emoji:'💊'},
  hardware:    {label:'Hardware Supplier',     emoji:'⚙️'},
  textile:     {label:'Textile Supplier',      emoji:'👕'},
  electronics: {label:'Electronics Dist.',     emoji:'🔌'},
};
...
export const DistSetup = () => {
  ...
  const handleNext = () => {
    ...
    setUser(prev => ({ ...prev, shop: shopName, name: ownerName, cat: category, loc: locState.name || 'India', role: 'distributor' }));
