...
const getFallbackRetailers = () => {
  return [
    {id: 1, name:'Ramesh Agro Traders',city:'Khetgaon',products:['Fertilizers','Seeds'],rating:4.7,distance:12,emoji:'🏪'},
    {id: 2, name:'Kisan Kendra',city:'Ujjain',products:['Agri Chemicals'],rating:4.3,distance:28,emoji:'🏪'},
    {id: 3, name:'Patel Seeds & Pesticides',city:'Indore',products:['Pesticides'],rating:4.5,distance:5,emoji:'🏪'},
    {id: 4, name:'Green Farm Supply',city:'Bhopal',products:['Organic Inputs'],rating:4.6,distance:18,emoji:'🏪'},
    {id: 5, name:'Malwa Traders',city:'Dewas',products:['Tools','Seeds'],rating:4.4,distance:22,emoji:'🏪'}
  ];
};
