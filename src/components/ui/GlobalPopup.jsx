...
export const GlobalPopup = () => {
  ...
  const getTheme = (type) => {
    switch (type) {
      case 'approved':  return { bg: 'rgba(120,242,117,0.12)', border: 'rgba(120,242,117,0.5)', btnBg: '#78f275', icon: '#78f275' };
      case 'pending':   return { bg: 'rgba(255,208,96,0.12)',  border: 'rgba(255,208,96,0.5)',  btnBg: '#ffd060', icon: '#ffd060' };
      case 'rejected':  return { bg: 'rgba(239,68,68,0.12)',   border: 'rgba(239,68,68,0.5)',   btnBg: '#ef4444', icon: '#ef4444' };
      case 'fulfilled': return { bg: 'rgba(96,165,250,0.12)',  border: 'rgba(96,165,250,0.5)',  btnBg: '#60a5fa', icon: '#60a5fa' };
      default:          return { bg: 'rgba(120,242,117,0.08)', border: 'rgba(120,242,117,0.3)', btnBg: '#78f275', icon: '#78f275' };
    }
  };
